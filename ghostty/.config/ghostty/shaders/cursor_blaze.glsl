...
// A sharp, clean white with a subtle gray outline
const vec4 TRAIL_COLOR = vec4(0.9, 0.9, 0.9, 1.0);        // Off-white
const vec4 TRAIL_COLOR_ACCENT = vec4(0.35, 0.35, 0.35, 1.0); // Dark Gray
